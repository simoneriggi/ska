...
//ClassImp(Caesar::SourceFinderP)

namespace Caesar {

#define MASTER_ID 0

SourceFinderP::SourceFinderP() {
...
void SourceFinderP::InitOptions(){
...
int SourceFinderP::PrepareWorkerTasks(){
...
int SourceFinderP::UpdateSourceFromWorkers(){
...
int SourceFinderP::FindSources(std::vector<Source*>& sources,Img* inputImg,double seedThr,double mergeThr){
...
int SourceFinderP::FindCompactSources(TaskData* taskData, Img* img){
...
int SourceFinderP::FindResidualMap(){
...
int SourceFinderP::FindExtendedSources(){
...
int SourceFinderP::FindExtendedSources_HClust(Img*){
...
int SourceFinderP::FindExtendedSources_ChanVese(Img* inputImg){
...
int SourceFinderP::FindExtendedSources_WT(Img* inputImg){
...
int SourceFinderP::SelectSources(std::vector<Source*>& sources){

	//## Find if source is at edge
	//...
	//...
...
bool SourceFinderP::IsGoodSource(Source* aSource){
...
bool SourceFinderP::IsPointLikeSource(Source* aSource){
...
Img* SourceFinderP::ReadImage(long int ix_min,long int ix_max,long int iy_min,long int iy_max){
...
BkgData* SourceFinderP::ComputeStatsAndBkg(Img* img){
...
int SourceFinderP::DrawSources(Img* image,std::vector<Source*>& sources){
