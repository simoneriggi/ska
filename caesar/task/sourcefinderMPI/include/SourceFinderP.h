...
#ifndef SourceFinderP_h
#define SourceFinderP_h 1
...
class SourceFinderP : public TObject {
	...
	//ClassDef(SourceFinderP,1)

};//close SourceFinder

/*
#ifdef __MAKECINT__
#pragma link C++ class SourceFinderP+;
#endif
*/
