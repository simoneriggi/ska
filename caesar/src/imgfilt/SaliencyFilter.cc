...
//Img* SaliencyFilter::ComputeMultiResoSaliencyMap(Img* img,int resoMin,int resoMax,int resoStep,double beta,int minRegionSize,double knnFactor,double spatialRegFactor,bool useRobustPars,bool addCurvDist,double salientMultiplicityThrFactor,bool addBkgMap,bool addNoiseMap,BkgData* bkgData,double saliencyThrFactor,double imgThrFactor){
